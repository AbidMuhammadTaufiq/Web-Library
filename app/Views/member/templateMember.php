...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/Member/index">
            ...
            <!-- Nav Item - Peminjaman -->
            <li class="nav-item">
                <a class="nav-link" href="/member/peminjamanIndex">
            ...
            <!-- Nav Item - Resensi -->
            <li class="nav-item">
                <a class="nav-link" href="/member/resensiIndex">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                ...
                                <a class="dropdown-item" href="/member/peminjamanIndex">
                                    <i class="fas fa-truck-loading fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Peminjaman
                                </a>
                                <a class="dropdown-item" href="/member/resensiIndex">
