        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="example" class="table table-striped" style="width:100%">
                    <thead>
                        <a href="/member/resensiTambah" class="btn btn-primary my-3">Tambah Resensi</a>
                    ...
                    <tbody>
                        <?php foreach ($resensi as $r) : ?>
                            <tr>
                                ...
                                <td><?= $r['fullname']; ?></td>
                                <td>
                                    <a href="/member/resensiIsi/<?= $r['id_resensi']; ?>" class="btn btn-success">Detail</a>
                                </td>
                                <td>
                                    <a href="/member/resensiEdit/<?= $r['id_resensi']; ?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>

                                    <form action="/member/<?= $r['id_resensi']; ?>" method="POST" class="d-inline">
                                        <?= csrf_field(); ?>
